...
from .analytics.data_quality import DataQualityAssessment
...
Examples:
  ...
  %(prog)s --generate-report --type executive
        ...
        parser.add_argument('--data-quality', action='store_true',
                          help='Perform comprehensive data quality assessment')
    ...
    def run_data_quality_assessment(self) -> Dict:
        """Run comprehensive data quality assessment."""
        self.logger.info("Running data quality assessment...")

        dq_assessment = DataQualityAssessment(self.data)

        # Run comprehensive assessment
        quality_report = dq_assessment.run_comprehensive_assessment()

        # Export detailed report
        report_filename = f"reports/data_quality_report_{datetime.now().strftime('%Y%m%d_%H%M%S')}.md"
        os.makedirs('reports', exist_ok=True)
        dq_assessment.export_report(report_filename)

        self.logger.info(f"Data quality report exported to {report_filename}")
